...
|                          | 📄        | Document – file                       |
|                          | 📋        | Clipboard – task list                 |
|                          | ℹ️        | Info – help or description            |
| 💻 Coding / Developer     | 💻        | Laptop – dev work                     |
|                          | 🖥️        | Desktop – setup                       |
|                          | 🧑‍💻       | Developer (neutral)                   |
|                          | 👨‍💻       | Male developer                        |
|                          | 👩‍💻       | Female developer                      |
|                          | 🖱️        | Mouse – interaction                   |
| 🚀 Deployment / Launch    | 🚀        | Rocket – deploy/ship                  |
|                          | 🎯        | Dart – target achieved                |
|                          | 🛫        | Plane takeoff – going live            |
