...
---
Now let's put the **actual values** into every part of the formula. 
...
\[
P(2 \mid Evem) = \frac{P(2 \cap Even)}{P(Even)}
\]
...
> The number is **2 AND even**.

Since 2 is even, there is only one outcome that satisfies both conditions:
